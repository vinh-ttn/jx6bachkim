...
TAB_LBPLD = {
			{szName="<color=pink>V‚ L©m L÷nh", tbProp={6,1,4903,1,0,0}, nCount = 5,nBindState = -2},
		}
...
if nRuong < SoLuongRuongTrongNhanThuong then
	...
	tbAwardTemplet:GiveAwardByList({tbProp = {6,1,4903,1,0,0}, nCount = 10,nBindState = -2}, "test", 1);
end
--------------------------------------------------------------------------------------------------------------------------------
--													TËng Kim																  --
--------------------------------------------------------------------------------------------------------------------------------
...
tbAwardTemplet:GiveAwardByList({tbProp = {6,1,4903,1,0,0}, nCount = 1,nBindState = -2}, "test", 1);
AddOwnExp(2000000)
end
--------------------------------------------------------------------------------------------------------------------------------
--														T›n S¯															 	  --
